...
public class frm_NavMyAccount extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nav_my_account);
        ...
        navView.setCheckedItem(R.id.nav_myAcc);
